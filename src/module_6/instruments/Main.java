...
нулевое. После выполнения метода из магазина должны пропасть те инструменты, которые были отгружены.
...
public class Main
{
    ...
    {
        Map<Instrument, List<Instrument>> order = new HashMap<>();

        Store store = new Store();
        store.printStore();

        Order currentOrder = new Order();
        currentOrder.create(order);
        currentOrder.printOrder(order);
