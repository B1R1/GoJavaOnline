...
public class SerialExecutorTest {
    ...
    public void testExecuteWithoutValidator() throws Exception {
        ...
        assertEquals(executor.getValidResults().get(0), 3, "Wrong execution results");
    }
    ...
    public void testExecuteWithValidator() throws Exception {
        ...
        assertEquals(executor.getInvalidResults().get(0), -1, "Wrong execution results");
    }
    ...
    public void testExecutor() throws Exception {
        ...
        assertEquals(executor.getValidResults().get(0), -1, "Wrong execution results");
        assertEquals(executor.getValidResults().get(1), 3, "Wrong execution results");

        assertEquals(executor.getInvalidResults().get(0), -1, "Wrong execution results");
        assertEquals(executor.getInvalidResults().get(1), Integer.MIN_VALUE, "Wrong execution results");
    }
