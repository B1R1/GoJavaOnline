...
public class Main {
    public static void main(String[] args) {
        Map<String, Integer> currentOrder = new HashMap<String, Integer>();

        Order firstOrder = new Order();
        firstOrder.createOrder(currentOrder);

        MusicStore store = new MusicStore();
        store.prepareInstruments(currentOrder);
        System.out.println("Order is ready for sending");
    }
}
